...
public class TestCompositeElementValidation {
  ...
  @Test
  public void checkImportCycleDueToVariableDefinition2() {
    try {
      final ValidatorTester<TargetPlatformValidator> tester = new ValidatorTester<TargetPlatformValidator>(this.validator, this.validatorRegistrar, this.languageName);
      final XtextResourceSet resourceSet = this.resourceSetProvider.get();
      StringConcatenation _builder = new StringConcatenation();
      ...
      _builder_1.append("target \"subTpd\"");
      _builder_1.newLine();
      _builder_1.append("include \"subInclude.tpd\"");
      _builder_1.newLine();
      _builder_1.append("include ${includeCircularURL}");
      _builder_1.newLine();
      this.parser.parse(_builder_1, URI.createURI("tmp:/subTpd.tpd"), resourceSet);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("target \"subInclude\"");
      _builder_2.newLine();
      _builder_2.append("define includeCircularURL = \"subSubTpd.tpd\"");
      _builder_2.newLine();
      this.parser.parse(_builder_2, URI.createURI("tmp:/subInclude.tpd"), resourceSet);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("target \"subSubTpd\"");
      _builder_3.newLine();
      _builder_3.append("include \"subTpd.tpd\"");
      _builder_3.newLine();
      ...
      final Consumer<AbstractValidationDiagnostic> _function_1 = new Consumer<AbstractValidationDiagnostic>() {
        ...
        public void accept(final AbstractValidationDiagnostic it) {
          Assert.assertEquals(TargetPlatformValidator.CHECK__INCLUDE_CYCLE, it.getIssueCode());
          EObject _sourceEObject = it.getSourceEObject();
          Assert.assertEquals("subTpd.tpd", ((IncludeDeclaration) _sourceEObject).getImportURI());
          Assert.assertEquals("Cycle detected in the included target platforms. Cycle is \'tmp:/subTpd.tpd\'\' -> \'tmp:/subSubTpd.tpd\'\' -> \'tmp:/subTpd.tpd\'.", it.getMessage());
        }
      };
      diagnotics.forEach(_function_1);
    } catch (Throwable _e) {
  ...
  @Test
  public void checkImportCycleDueToVariableOverrideFromImporterTarget() {
    try {
      final ValidatorTester<TargetPlatformValidator> tester = new ValidatorTester<TargetPlatformValidator>(this.validator, this.validatorRegistrar, this.languageName);
      final XtextResourceSet resourceSet = this.resourceSetProvider.get();
      StringConcatenation _builder = new StringConcatenation();
      ...
      _builder.newLine();
      final TargetPlatform compositeIncludeTarget = this.parser.parse(_builder, URI.createURI("tmp:/a.tpd"), resourceSet);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("target \"b\"");
      _builder_1.newLine();
      _builder_1.append("include \"c.tpd\"");
      _builder_1.newLine();
      _builder_1.append("define includeURL = \"b.tpd\"");
      _builder_1.newLine();
      this.parser.parse(_builder_1, URI.createURI("tmp:/b.tpd"), resourceSet);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("target \"c\"");
      _builder_2.newLine();
      _builder_2.append("define includeURL = \"d.tpd\"");
      _builder_2.newLine();
      _builder_2.append("include ${includeURL}");
      _builder_2.newLine();
      this.parser.parse(_builder_2, URI.createURI("tmp:/c.tpd"), resourceSet);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("target \"d\"");
      _builder_3.newLine();
      this.parser.parse(_builder_3, URI.createURI("tmp:/d.tpd"), resourceSet);
      Assert.assertTrue(compositeIncludeTarget.eResource().getErrors().isEmpty());
      tester.validator().checkImportCycle(compositeIncludeTarget);
      List<AbstractValidationDiagnostic> diagnotics = IterableExtensions.<AbstractValidationDiagnostic>toList(Iterables.<AbstractValidationDiagnostic>filter(tester.diagnose().getAllDiagnostics(), AbstractValidationDiagnostic.class));
      Assert.assertEquals(1, diagnotics.size());
