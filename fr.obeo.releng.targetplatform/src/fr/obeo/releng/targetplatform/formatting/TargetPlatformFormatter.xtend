...
class TargetPlatformFormatter extends AbstractDeclarativeFormatter {
	...
	override protected void configureFormatting(FormattingConfig c) {
    	...
    	c.setNoLinewrap.around(locationAccess.discardStateAssignment_1_1_2)
    	c.setNoLinewrap.around(locationAccess.compositeUriAssignment_1_2)
		...
		c.setNoLinewrap.before(IUAccess.versionAssignment_1_1_0_0)
		c.setNoLinewrap.before(IUAccess.versionAssignment_1_1_0_1)
		c.setNoLinewrap.before(IUAccess.varVersionAssignment_1_1_1)
